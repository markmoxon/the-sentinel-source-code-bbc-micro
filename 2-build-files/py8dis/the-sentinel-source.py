...
byte(0x4A00, 0x4AE0 - 0x4A00, cols=8)
byte(0x4AE0, 0x4C20 - 0x4AE0, cols=8)
byte(0x4C20, 0x4D60 - 0x4C20, cols=8)
byte(0x4D60, 0x4EA0 - 0x4D60, cols=8)
byte(0x4EA0, 0x4F40 - 0x4EA0, cols=8)
label(0x4F40, "L4F40")
byte(0x4F40, 0x4FE0 - 0x4F40, cols=8)
byte(0x4FE0, 0x5080 - 0x4FE0, cols=8)
label(0x5080, "L5080")
byte(0x5080, 0x5120 - 0x5080, cols=8)
byte(0x5120, 0x51C0 - 0x5120, cols=8)
label(0x51C0, "L51C0")
byte(0x51C0, 0x5260 - 0x51C0, cols=8)
label(0x5260, "L5260")
byte(0x5260, 0x54A0 - 0x5260, cols=8)
byte(0x54A0, 0x5500 - 0x54A0, cols=8)
byte(0x5500, 0x5520 - 0x5500, cols=8)
byte(0x5520, 0x5560 - 0x5520, cols=8)
entry(0x5560, "sub_C5560")
byte(0x5783, 0x5800 - 0x5783, cols=8)
label(0x5800, "L5800")
byte(0x5800, 0x581C - 0x5800, cols=8)
byte(0x5850, 0x58B0 - 0x5850, cols=8)
byte(0x58B0, 0x5900 - 0x58B0, cols=8)
label(0x5900, "L5900")
byte(0x5900, 0x5980 - 0x5900, cols=8)
byte(0x5980, 0x5A00 - 0x5980, cols=8)
label(0x5A00, "Noise2")
byte(0x5A00, 0x5B00 - 0x5A00, cols=8)
label(0x5B00, "Noise3")
byte(0x5B00, 0x5C00 - 0x5B00, cols=8)
